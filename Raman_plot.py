...
# plotting maxima shortened

class Raman_plotting(tk.Toplevel):
    ...
    def overlaying_plot(self):
        ...
        submit_Button = Button(self, text='submit', bg=HIERNtheme.myorange, fg=HIERNtheme.mywhite, font=HIERNtheme.standard_font, command=lambda:self.__Raman_double_plotting(self.row.get(), self.column.get()))
        submit_Button.grid(row=10, column=5)

        self.update_idletasks()
        self.deiconify()

    def __Raman_double_plotting(self, row, column):
        ...
        if self.row.get() == 'A':
            for i in range(0,8):
                ...
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[0].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i])
        ...
        if self.column.get() == '1':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i])
        ...
        if self.column.get() == '2':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+1-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=str(MyUtils.plate[i+1]))
        ...
        if self.column.get() == '3':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+2-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+2])
        ...
        if self.column.get() == '4':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+3-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+3])
        ...
        if self.column.get() == '5':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+4-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+4])
        ...
        if self.column.get() == '6':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+5-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+5])
        ...
        if self.column.get() == '7':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+6-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+6])
        ...
        if self.column.get() == '8':
            for i in range (0,48,8):
                ...
                j = int(i/8)
                if MyUtils.plate[i] in MyUtils.chosen:   
                    axs[1].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i+7-8*j],green[j],blue[0],alpha[0]], linewidth=1.5, label=MyUtils.plate[i+7])
        ...
        cName8 = os.path.join(path.completeName7, single_fit)
    ...
    def Raman_peak_plotting(chosen, x_Raman, Raman_data, maxima_list, local_max):

        #Raman_data_evaluation.x_Raman = [None]*96

        #for k in range(0,96,2):
            
            #Raman_data_evaluation.x_Raman[k] = Raman_data_evaluation.Raman_data.iloc[:290,k]
        ...
        fig.text(0.5, 0.0, 'wavenumber', ha='center')
        fig.text(0.0, 0.5, 'intensity', va='center', rotation='vertical')
        ...
        for i in range(0,48):
            ...
            for i in range(0,8):
                ...
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[j,i-8*j].plot(Raman_data_evaluation.x_Raman[k], Raman_data_evaluation.Raman_data.iloc[0:290,k+1], color=[red[i-8*j],green[j],blue[0],alpha[0]], linewidth=1.5)
                    axs[j,i-8*j].plot(Raman_data_evaluation.maxima_list[k], Raman_data_evaluation.local_max[k], 'x', color=[0.38,0.38,0.38,1], linewidth=1.5)
            for i in range(8,16):
                k = i*2
                j = 1
                axs[j,i-8*j].set_title(MyUtils.plate[i])
    ...
    def Raman_fit_plotting(chosen, x_Raman, Raman_data, LorentzFits_Raman):
        ...
        for i in range(0,48):
            ...
            for i in range(0,8):
                ...
                axs[j,i-8*j].set_title(MyUtils.plate[i])
                if MyUtils.plate[i] in MyUtils.chosen:
                    axs[j,i-8*j].plot(Raman_data_evaluation.x_Raman[i*2], Raman_data_evaluation.Raman_data.iloc[0:290,i*2+1], color=[red[i-8*j],green[j],blue[0],alpha[0]], linewidth=1.5)
                    if len(Raman_data_evaluation.maxima_list[i*2]) <= 8 and len(Raman_data_evaluation.maxima_list[i*2]) >=2:
                        axs[j,i-8*j].plot(Raman_data_evaluation.x_Raman[i*2], Raman_data_evaluation.LorentzFits_Raman[i*2].best_fit, '--', color=[0.38,0.38,0.38,1], linewidth=1.5)
            for i in range(8,16):
                j = 1
                axs[j,i-8*j].set_title(MyUtils.plate[i])
                if MyUtils.plate[i] in MyUtils.chosen:
