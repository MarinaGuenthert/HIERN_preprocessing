...
class Tauc_plot_Eg(tk.Toplevel):
    ...
    def show(self):
        ...
        submit_Button = Button(self, text='submit', bg=HIERNtheme.myorange, fg=HIERNtheme.mywhite, font=HIERNtheme.standard_font, command=lambda:self.__plot_3D_Eg(self.geometry, self.variable.get()))
    ...
    def __plot_3D_Eg(self, geometry, variable):
        ...
        result1 = np.array(MyUtils.Eg_list_direct)
        result2 = np.array(MyUtils.Eg_list_indirect)
        ...
        #if self.__save_v == 'on':
        plt.savefig(path.completeName10, transparent = False)
